...
import 'package:mitane_frontend/presentation/pages/farmer/with_out_search_bar.dart';

class SmileFarmerProfilePage extends StatelessWidget {
  const SmileFarmerProfilePage({ Key? key}) : super(key: key);
